...
from lexical_sae.training.losses import AttributionCentroidTracker
from lexical_sae.core.constants import CIRCUIT_MASS_FRACTION, EVAL_BATCH_SIZE
from lexical_sae.evaluation.circuit_metrics import (extract_vocabulary_circuit,
                                     measure_circuit_completeness,
                                     measure_separation_cosine,
                                     measure_separation_jaccard)
from lexical_sae.evaluation.autointerp import run_autointerp
from lexical_sae.evaluation.baselines import run_explainer_comparison
from lexical_sae.evaluation.downstream_loss import compute_downstream_loss
from lexical_sae.evaluation.eraser import run_eraser_evaluation
from lexical_sae.evaluation.feature_absorption import detect_feature_absorption
from lexical_sae.evaluation.mib_metrics import compute_cmd, compute_cpr
from lexical_sae.evaluation.polysemy import compute_contextual_consistency_score
from lexical_sae.evaluation.results import MechanisticResults
from lexical_sae.evaluation.sparse_probing import run_sparse_probing
from lexical_sae.evaluation.sparsity_frontier import compute_naopc, sweep_sparsity_frontier
from lexical_sae.core.attribution import compute_attribution_tensor
from lexical_sae.evaluation.layerwise import run_layerwise_evaluation
from lexical_sae.runtime import autocast, DEVICE, unwrap_compiled
...
def run_mechanistic_evaluation(
    ...
    if run_sae_comparison:
        from lexical_sae.baselines.sae import compare_sae_with_dla
    ...
    if run_transcoder_comparison:
        from lexical_sae.baselines.transcoder import run_transcoder_comparison as _run_tc
    ...
    if run_disentanglement:
        from lexical_sae.evaluation.disentanglement import compute_scr, compute_tpp
