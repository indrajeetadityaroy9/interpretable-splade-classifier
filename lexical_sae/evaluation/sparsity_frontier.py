...
from lexical_sae.evaluation.collect import collect_sparse_and_attributions
from lexical_sae.evaluation.downstream_loss import compute_downstream_loss
from lexical_sae.evaluation.eraser import (
    compute_aopc,
    compute_comprehensiveness,
    compute_sufficiency,
)
from lexical_sae.runtime import autocast, unwrap_compiled
from lexical_sae.core.constants import EPSILON, EVAL_BATCH_SIZE
...
def compute_naopc(
    ...
    return {
        "naopc_comprehensiveness": dla_aopc_comp / max(random_aopc_comp, EPSILON),
        "naopc_sufficiency": dla_aopc_suff / max(random_aopc_suff, EPSILON),
