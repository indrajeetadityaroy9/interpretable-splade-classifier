...
from lexical_sae.evaluation.collect import collect_sparse_vectors
...
from lexical_sae.core.constants import EVAL_BATCH_SIZE
...
def _get_last_layer_cls_attention(
    ...
    from lexical_sae.evaluation.layerwise import _get_transformer_layers
    ...
    cls_attn = cls_attn / cls_attn.sum(dim=1, keepdim=True).clamp(min=EPSILON)
