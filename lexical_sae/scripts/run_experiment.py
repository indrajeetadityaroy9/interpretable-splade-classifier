...
from lexical_sae.evaluation.orchestrator import run_mechanistic_evaluation
from lexical_sae.evaluation.results import print_comparison_table, print_mechanistic_results
from lexical_sae.evaluation.collect import prepare_mechanistic_inputs
...
def run(config: Config) -> dict:
    ...
    if config.evaluation.train_dense_baseline:
        from lexical_sae.baselines.dense import (
